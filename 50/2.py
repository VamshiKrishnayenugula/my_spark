...
filtered_df.write.mode('overwrite').csv(r'D:\My_learning\spark\50\results\filtered_results12.csv', header=True)
...
# Save the aggregated DataFrame to a CSV file
aggregated_df.write.mode('overwrite').csv(r'D:\My_learning\spark\50\results\aggregated_results12.csv', header=True)
